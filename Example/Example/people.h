...
@class T1;
@interface testT:BGBaseModel
@property(nonatomic,strong) id t1;
@end

@interface T1:  BGBaseModel
@property(nonatomic,copy) NSString* name;
@end
