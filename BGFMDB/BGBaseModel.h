...
@interface BGBaseModel: NSObject<BGProtocol>

/**
 本库自带的主键.
 */
@property (nonatomic, strong) NSString * _Nonnull bg_id;
...
/**
 遍历字典元素.
 */
+ (void)bg_enumerateKeysAndObjectsUsingBlock:(void (^ _Nonnull)(NSString * _Nonnull key, id _Nonnull value,BOOL * _Nullable stop))block;
